...
class image(Resource):
    ...
    def post(self):
        ...
        if Image.find_by_name(filename):
            return {'msg': "An image with name '{}' already exists.".format(filename)}, 400
        ...
        try:
            ...
            return {"msg": "An error occurred inserting the image."}, 500
